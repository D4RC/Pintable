...
function ColorPalette(props) {
    ...
    function buttonDisplay() {
        if(status==='loading')
            ...
            return (
            <div className=" border-gray-200 h-8 w-8">
                <img src="https://img.icons8.com/fluent/96/000000/paint-palette.png"/>
            </div>)
        else if(status==='resolved')
            return (<div className=" border-gray-200 h-8 w-8">
                ...
                {colours.map(colour => {
                    ...
                    return (
                        <div
                            ...
                            className={`h-16 w-16 m-2 border border-gray-400 shadow rounded ${isSelected ? 'color--selected' : ''}`}
